...
class CategoryModelTest(TestCase):
    ...
    def setUp(self):
        self.parent_category = Category.objects.create(
            name="Nabiał", meta={"expiry_days": 14}
        )
        self.child_category = Category.objects.create(
            name="Mleko", parent=self.parent_category, meta={"expiry_days": 7}
        )
...
class ProductModelTest(TestCase):
    ...
    def test_get_all_names(self):
        ...
        product_no_brand = Product.objects.create(
            name="Generic Cola", aliases=["Generic"]
        )
    ...
    def test_ghost_product(self):
        ...
        ghost = Product.objects.create(name="Unknown Product", is_active=False)
...
class InventoryItemModelTest(TestCase):
    ...
    def setUp(self):
        self.product = Product.objects.create(
            name="Test Product", reorder_point=Decimal("5.000")
        )
    ...
    def test_consume(self):
        ...
        self.assertEqual(
            self.inventory_item.quantity_remaining, initial_quantity - consume_qty
        )
...
class ConsumptionEventModelTest(TestCase):
    ...
    def test_consumption_defaults(self):
        ...
        consumption = ConsumptionEvent.objects.create(
            inventory_item=self.inventory_item, consumed_qty=Decimal("1.000")
        )
