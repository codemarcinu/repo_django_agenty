...
class ReceiptLineItem(models.Model):
    ...
    product_name = models.CharField(
        max_length=300,
        db_index=True,
        help_text="Original product name from receipt"
    )
...
class InventoryItem(models.Model):
    ...
    purchase_date = models.DateField(
        help_text="Date when the product was purchased"
    )
    expiry_date = models.DateField(
        null=True, 
        blank=True,
        help_text="Expiry date (calculated or manual)"
    )
...
class ConsumptionEvent(models.Model):
    ...
    consumed_at = models.DateTimeField(
        ...
        help_text="When the consumption occurred"
    )
    notes = models.TextField(
        blank=True, 
        default='',
        help_text="Optional notes about consumption"
    )
