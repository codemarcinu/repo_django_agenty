...
class ProductAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("name", "brand", "barcode", "category", "is_active")}),
        ("Inventory Settings", {"fields": ("reorder_point",)}),
        ("Data", {"fields": ("nutrition", "aliases"), "classes": ("collapse",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ReceiptAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("OCR Data", {"fields": ("raw_text",), "classes": ("collapse",)}),
        (
            "Timestamps",
            {"fields": ("created_at", "updated_at"), "classes": ("collapse",)},
        ),
...
class ReceiptLineItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("receipt", "product_name", "matched_product")}),
        (
            "Quantities & Prices",
    ...
    def get_receipt_info(self, obj):
        ...
        return format_html(
            '<a href="{}">{} - {}</a>',
            url,
            obj.receipt.store_name,
            obj.receipt.purchased_at.date(),
        )
...
class InventoryItemAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("product", "purchase_date", "expiry_date")}),
        (
            "Quantity & Storage",
...
class ConsumptionEventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        (None, {"fields": ("inventory_item", "consumed_qty", "consumed_at", "notes")}),
    ...
    def get_inventory_item_info(self, obj):
        ...
        url = reverse(
            "admin:inventory_inventoryitem_change", args=[obj.inventory_item.id]
        )
        return format_html(
            '<a href="{}">{} ({}{})</a>',
            url,
