    ...
    def handle(self, *args, **options):
        ...
        agents_data = [
            {
                ...
                'capabilities': ['general_conversation', 'question_answering', 'friendly_chat', 'help'],
            ...
            },
            {
                ...
                'capabilities': ['technical_support', 'programming_help', 'system_architecture', 'troubleshooting'],
                'config': {'temperature': 0.3, 'max_tokens': 800, 'expertise_area': 'IT'}
            },
            {
                ...
                'capabilities': ['task_management', 'project_planning', 'organization', 'goal_setting'],
            ...
            },
            {
                ...
                'capabilities': ['data_analysis', 'pattern_recognition', 'reporting', 'insights_generation'],
        ...
        for agent_data in agents_data:
            ...
            if created:
                ...
                updated_count += 1
                self.stdout.write(
                    self.style.WARNING(f'⚠️  Updated agent: {agent.name}')
                )
