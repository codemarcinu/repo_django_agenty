...
class ReceiptCacheManager:
    ...
    def get_cached_parsed_receipt(self, receipt_id: int) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_cached_product_matches(self, product_text: str) -> Optional[List[Dict[str, Any]]]:
        """
    ...
    def get_cached_analytics(self, analytics_key: str) -> Optional[Dict[str, Any]]:
        """
...
def get_cached_ocr_result(file_content: bytes) -> Optional[Dict[str, Any]]:
...
def get_cached_receipt_data(receipt_id: int) -> Optional[Dict[str, Any]]:
