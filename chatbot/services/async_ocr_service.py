...
from .exceptions_receipt import OCRError, FileValidationError
...
class AsyncOCRService:
    ...
    async def _extract_text_from_image_async(self, image_path: str) -> Optional[str]:
    ...
    async def _extract_text_from_pdf_async(self, pdf_path: str) -> Optional[str]:
