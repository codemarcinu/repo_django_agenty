...
from inventory.models import Product, Category, Receipt, ReceiptLineItem, InventoryItem
...
class InventoryServiceTest(TestCase):
    ...
    def test_calculate_expiry_date_from_category_meta(self):
        ...
        expiry_date = self.service._calculate_expiry_date(self.milk_product, purchase_date)
        ...
        expiry_date = self.service._calculate_expiry_date(self.chicken_product, purchase_date)
    ...
    def test_calculate_expiry_date_from_product_name(self):
        ...
        expiry_date = self.service._calculate_expiry_date(self.bread_product, purchase_date)
    ...
    def test_process_receipt_for_inventory_errors(self):
        ...
        success, message = self.service.process_receipt_for_inventory(incomplete_receipt.id)
        self.assertFalse(success)
...
class InventoryServiceIntegrationTest(TestCase):
    ...
    def setUp(self):
        ...
        self.categories = {
            ...
            'bread': Category.objects.create(name='Bread & Bakery', meta={'expiry_days': 3}),
            'meat': Category.objects.create(name='Meat & Poultry', meta={'expiry_days': 2}),
        }
    ...
    def test_full_receipt_processing_workflow(self):
        ...
        self.assertEqual(chicken_item.unit, 'kg')
        self.assertEqual(
            chicken_item.expiry_date, 
            receipt.purchased_at.date() + timedelta(days=2)
        )
