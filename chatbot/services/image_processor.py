...
class ReceiptImageProcessor:
    ...
    def detect_receipt_area(self, image: np.ndarray) -> Tuple[Optional[np.ndarray], float]:
        """
    ...
    def correct_perspective(self, image: np.ndarray) -> Tuple[Optional[np.ndarray], float]:
        """
    ...
    def enhance_contrast(self, image: np.ndarray) -> Optional[np.ndarray]:
        """
    ...
    def reduce_noise(self, image: np.ndarray) -> Optional[np.ndarray]:
        """
