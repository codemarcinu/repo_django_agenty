...
class RepositoryProtocol(Protocol):
    ...
    async def get_by_id(self, receipt_id: int) -> Any | None: ...
    async def update_status(self, receipt_id: int, status: str, error_message: str | None = None) -> bool: ...
...
class ReceiptProcessorV2:
    ...
    def __init__(
        ...
        config: ReceiptProcessingConfig | None = None
    ):
